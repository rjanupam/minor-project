    ...
    <div className="grid grid-rows-12 max-h-max h-min">
      ...
      <div className="grid grid-cols-12 gap-4 h-32 row-span-9">
        <div className="col-span-5 m-4 p-10">
          <p>
            ...
            doloribus voluptatibus dolorum labore dolore nulla reiciendis eum
            eius nostrum qui sit velit omnis, corporis explicabo? Tenetur,
            expedita adipisci? Eum, fugit.
          </p>
        </div>
      ...
      <footer className="bg-gray-800 text-white text-center row-span-1">
        <div className="flex-grow text-red-600 bg-zinc-500 p-4">
          <p>
            Disclaimer: Lorem ipsum dolor sit, amet consectetur adipisicing
            elit. Doloribus, iusto in officiis beatae maiores nulla vero
            laboriosam sint quidem nesciunt tenetur ex est! Nesciunt, voluptate
            recusandae laudantium tenetur dicta dolorum!
          </p>
        </div>
        <p>
          © 2024 Lung Care.AI. All rights reserved. This application is not a
